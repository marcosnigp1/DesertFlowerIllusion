...
# ----
# Am I the photoresistor?
# ----

this_photoresistor = True
we_can_light = False
...
while True:
    try:
        ...
        if (receiving_pin_1.value == True or receiving_pin_2.value == True) and this_photoresistor == False:
            we_can_light = True
        ...
        if we_can_light == True:
            ...
            # Then what is this code for?....
                ...
                # Make sound
                global_volume = 1.0
                cooldown = 20.0  # Cooldown has to be 0 preferably to avoid a silence gap.
